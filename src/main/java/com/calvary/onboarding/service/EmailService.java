...
public class EmailService {
	...
	public String sendWelcomeEmail(String to, String firstName, String lastName, String password) {
		...
		String body = "@Kelly  <html lang='en'>\r\n"
				...
				+ "                <a href=https://mngp.vercel.app/payment?${userId} style=\"text-decoration: none; border: 1px solid #c71e4c; padding: 16px; margin: 5px 0; color: white; background-color: #c71e4c; display: block; width: 40%\">Proceed to payment</a>\r\n"
				+ "              </td>\r\n"
				+ "            </tr>\r\n"
				+ "            <tr>\r\n"
				+ "              <td style='padding: 10px 0; color: #333333;'>\r\n"
